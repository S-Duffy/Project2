...
/* ./.libs/lt-AutomatedTest.c - temporary wrapper executable for .libs/AutomatedTest
   Generated by libtool (GNU libtool) 2.4.6

   The AutomatedTest program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "/ECEN5813/Project2/CUnit/CUnit-2.1-3/Examples:/ECEN5813/Project2/CUnit/CUnit-2.1-3/CUnit/Sources:";
const char * TARGET_PROGRAM_NAME = "AutomatedTest"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# AutomatedTest - temporary wrapper script for .libs/AutomatedTest\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The AutomatedTest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"AutomatedTest:AutomatedTest:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"AutomatedTest:AutomatedTest:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"AutomatedTest:AutomatedTest:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=/ECEN5813/Project2/CUnit/CUnit-2.1-3/Examples:/ECEN5813/Project2/CUnit", f);
  fputs ("/CUnit-2.1-3/CUnit/Sources:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
