...
/* ./.libs/lt-ConsoleTest.c - temporary wrapper executable for .libs/ConsoleTest
   Generated by libtool (GNU libtool) 2.4.6

   The ConsoleTest program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ConsoleTest"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ConsoleTest - temporary wrapper script for .libs/ConsoleTest\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The ConsoleTest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ConsoleTest:ConsoleTest:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ConsoleTest:ConsoleTest:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ConsoleTest:ConsoleTest:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
