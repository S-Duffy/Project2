...
/* ./.libs/lt-test_cunit.c - temporary wrapper executable for .libs/test_cunit
   Generated by libtool (GNU libtool) 2.4.6

   The test_cunit program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "/ECEN5813/Project2/CUnit/CUnit-2.1-3/CUnit/Sources:";
const char * TARGET_PROGRAM_NAME = "test_cunit"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_cunit - temporary wrapper script for .libs/test_cunit\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The test_cunit program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test_cunit:test_cunit:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_cunit:test_cunit:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_cunit:test_cunit:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
  ...
  fputs ("    PATH=/ECEN5813/Project2/CUnit/CUnit-2.1-3/CUnit/Sources:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
